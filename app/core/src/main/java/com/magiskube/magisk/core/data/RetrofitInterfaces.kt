package com.magiskube.magisk.core.data

import com.magiskube.magisk.core.model.ModuleJson
import com.magiskube.magisk.core.model.Release
import com.magiskube.magisk.core.model.UpdateJson
...
interface GithubApiServices {
    ...
    suspend fun fetchReleases(
        ...
        @Path("repo") repo: String = "MagisKube",

...
import com.magiskube.magisk.core.ktx.timeDateFormat
import com.magiskube.magisk.core.ktx.toTime
import com.magiskube.magisk.core.model.su.SuLog
...
class SuLogRvItem(val log: SuLog) : ObservableRvItem(), DiffItem<SuLogRvItem> {
    ...
    @get:Bindable
    val bulletRes: Int
        get() = if (log.action == 2) R.drawable.ic_close_md2 else R.drawable.ic_check_md2

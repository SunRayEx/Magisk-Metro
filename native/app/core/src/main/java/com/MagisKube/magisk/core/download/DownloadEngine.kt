package com.MagisKube.magisk.core.download
...
import com.MagisKube.magisk.core.AppContext
import com.MagisKube.magisk.core.Const
import com.MagisKube.magisk.core.JobService
import com.MagisKube.magisk.core.R
import com.MagisKube.magisk.core.base.IActivityExtension
import com.MagisKube.magisk.core.cmp
import com.MagisKube.magisk.core.di.ServiceLocator
import com.MagisKube.magisk.core.intent
import com.MagisKube.magisk.core.ktx.set
import com.MagisKube.magisk.core.utils.ProgressInputStream
import com.MagisKube.magisk.view.Notifications
...
class DownloadEngine(session: DownloadSession) : DownloadSession by session, DownloadNotifier {
    ...
    companion object {
        const val ACTION = "com.MagisKube.magisk.DOWNLOAD"
        ...
        private fun createBroadcastIntent(context: Context, subject: Subject) =
            context.intent<com.MagisKube.magisk.core.Receiver>()
                .setAction(ACTION)
                .putExtra(SUBJECT_KEY, subject)

        private fun createServiceIntent(context: Context, subject: Subject) =
            context.intent<com.MagisKube.magisk.core.Service>()
                .setAction(ACTION)
                .putExtra(SUBJECT_KEY, subject)
